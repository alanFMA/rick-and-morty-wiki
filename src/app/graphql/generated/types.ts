...
export type GetCharacterDetailsQuery = {
  character?: {
    ...
    gender?: string | null;
    image?: string | null;
    episode: Array<{ name?: string | null; air_date?: string | null } | null>;
...
export type GetCharactersQuery = {
  characters?: {
    info?: { pages?: number | null; count?: number | null } | null;
    results?: Array<{
      id?: string | null;
      name?: string | null;
      status?: string | null;
...
export function useGetCharacterDetailsQuery(
  ...
  > &
    (
      | { variables: GetCharacterDetailsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
...
export function useGetCharacterDetailsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
>;
export type GetCharacterDetailsSuspenseQueryHookResult = ReturnType<
  typeof useGetCharacterDetailsSuspenseQuery
>;
...
export function useGetCharactersQuery(
  ...
  > &
    (
      | { variables: GetCharactersQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
